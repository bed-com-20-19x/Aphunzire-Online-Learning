                                ...
                                <div class="span8">
                                    <form class="" id="add_downloadble" method="post">
                                        <div class="control-group">
                                            <div class="controls">
                                                <textarea name="content" id="ckeditor full"></textarea>
                                        ...
                                        <script>
                                            jQuery(document).ready(function($){
                                                  $("#add_downloable").submit(function(e){
                                                  e.preventDefault();
                                                  ...
                                                  $.ajax({
                                                    ...
                                                    success:function(html){
                                                        $.jGrowl("student successful Added", { header: 'Student Added'});
                                        ...
                                        <div class="span4">
                                            <div class="alert alert-info">
                                                Check The Class you want to put this file.
                                            ...
                                            <table cellpadding="0" cellspacing="0" boarder="0" class="table" id="">
                                                <thead>
                                                    <tr>
                                                        <th>Class Name</th>
                                                        <th>Subject Code</th>
                                                 ...
                                                 while($row = mysqli_fetch_array($query)){
                                                    ...
                                                    <td width ="30">
                                                        <input id="" class="selector[]" type="checkbox" value="<?php echo $id; ?>">
