        ...
        <div class="row-fluid">
            ...
            <div class="span9" id="content">
                ...
                <div class="row-fluid">
                    ...
                    <!-- block -->
                    <div class="block_bg" class="block">
                        <div class="navbar navbar-inner block-header ">
                            <div class="muted pull-left">Data Number</div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <div class="span3">
                                    <div class="chart" data-parcent="<?php echo $count_reg_teacher; ?>"><?php echo $count_reg_teacher; ?></div>
