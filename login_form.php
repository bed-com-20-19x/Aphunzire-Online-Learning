			<form id="login_form1" class="form-signin" method="post" style="color: white;">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to Aphunzire E-Learning System", { header: 'Access Granted' });
									var delay = 1000;
			...
			<div id="button_form" class="form-signin" style="color: white; font-size:larger" >
			New to Aphunzire PlatForm
			<hr>
