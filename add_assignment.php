                        ...
                        <div class="span4">
                            <form class="" id="add_downloadable" method="post" enctype="multipart/form-data" name="upload">
                               <div class="control-group">
                                ...
                                <div class="control">
                                    <input name="upload_file" class="input-file uniform_on" id="fileInput" type="file">
                               ...
                               <div class="control-group">
                                <div class="controls">
                                    <textarea name="desc" id="assigntextare" placeholder="Description" required></textarea>
                            ...
                            <div class="alert alert-info">Check The Class you wnt to put this file. </div>
                            <div class="pull-left">
